            ...
            <aside id="colorlib-aside" role="complementary" class="js-fullheight">
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        <li class="colorlib-active"><a href="{{route('posts.index')}}">Home</a></li>

                        @if(Auth::user())
                            <li><a href="{{route('logout')}}" class="text-danger">Logout ({{Auth::user()->name}})</a>
                            </li>
                        @else
                ...
                <div class="colorlib-footer">
                    ...
                    <p class="pfooter">
                        ...
                        by <a href="https://wa.me/+201028720750" target="_blank">B A I O M Y</a>
